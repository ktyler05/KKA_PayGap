...
const questionLorems = [
  "Crucially, the gender pay gap increases over time; widening gradually but significantly from an individual’s late 20s and early 30s. Men’s wages tend to continue growing rapidly at this point in the life cycle (particularly for the highly educated), while women's wages plateau.\n\nOn average, every month working women take home £631 less than men - that’s £7,572 over the course of the year. This means that on average women ‘stop earning’ on November 20th every year – from which date they effectively work for free compared to their male counterparts.\n\nAccording to Young Women’s Trust, about one fifth of the gender pay gap can be accounted for by differing jobs and sectors. By contrast, around two thirds of the income gap occurs because women are paid less even when working in similar jobs and sectors and having similar characteristics.",
    ...
    <div className="wrapper">
      ...
      <div className="lorem-container" style={{ marginBottom: "1rem" }}>
        ...
        <p>
          ...
          and career paths and therefore the disparity can be explained by a
        ...
        <p>
          ...
          occupations. Even when men and women work the same hours and in the
          same roles, nearly two-thirds of the gender pay gap remains
          unexplained.
        </p>
        <p>
          Gendered labour market inequalities therefore require a more nuanced
          understanding of the societal and economic forces which underpin their
          perpetuation.
        </p>
      </div>
